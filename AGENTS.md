...
Do not use Playwright (or any browser automation) to test or verify work — the user tests manually. Only drive a browser when explicitly asked to. Verification otherwise stops at type-check/build/tests/lint.
